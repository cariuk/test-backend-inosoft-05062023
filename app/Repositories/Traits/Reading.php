...
trait Reading
{
     ...
     * apply filter.
     */
    protected function applyFilter(Request $request, $builder): void
    {
    }
     ...
     * apply sort.
     */
    protected function applySort(Request $request, $builder): void
    {
        if ($this->sortable) {
     ...
     * get collection.
     */
    protected function getCollection(Request $request, $builder, bool $shouldPaginate = null): Collection | LengthAwarePaginator
    {
